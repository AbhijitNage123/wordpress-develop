 ...
 *                                    Default 'false'.
 */
function wp_override_script( $scripts, $handle, $src, $deps = array(), $ver = false, $in_footer = false ) {
 ...
 */
function wp_register_package_scripts( $scripts ) {
...
add_action( 'wp_default_scripts', 'wp_register_package_scripts' );
