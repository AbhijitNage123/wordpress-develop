 ...
 *
 * Note: These styles can be overridden by calling wp_override_style()
 ...
 */
function wp_override_style( $styles, $handle, $src, $deps = array(), $ver = false, $media = 'all' ) {
 ...
 * @param WP_Styles $styles WP_Styles instance.
 */
function wp_register_package_styles( $styles ) {
...
add_action( 'wp_default_styles', 'wp_register_package_styles' );
